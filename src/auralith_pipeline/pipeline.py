...
from auralith_pipeline.sources.data_sources import DataSource, DataSample
...
from auralith_pipeline.sharding.shard_writer import ShardWriter, ShardIndex
from auralith_pipeline.utils.helpers import format_size, format_number
...
class Pipeline:
    ...
    def __init__(self, config: Optional[PipelineConfig] = None):
        ...
        self._tokenizer: Optional[TokenizationPipeline] = None

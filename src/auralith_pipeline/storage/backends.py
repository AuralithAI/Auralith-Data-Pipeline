...
class HuggingFaceStorage(StorageBackend):
    ...
    def __init__(self, repo_id: str, token: Optional[str] = None, repo_type: str = "dataset"):
...
class S3Storage(StorageBackend):
    ...
    def upload(self, local_path: str, remote_path: str = "") -> UploadResult:
        ...
        try:
            ...
            if local_path.is_file():
                key = f"{self.prefix}/{remote_path}" if remote_path else f"{self.prefix}/{local_path.name}"
...
class GCSStorage(StorageBackend):
    ...
    def upload(self, local_path: str, remote_path: str = "") -> UploadResult:
        ...
        try:
            ...
            if local_path.is_file():
                blob_name = f"{self.prefix}/{remote_path}" if remote_path else f"{self.prefix}/{local_path.name}"
